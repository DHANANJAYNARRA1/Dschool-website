...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-gradient-to-br from-slate-50 to-blue-50">
      {/* Hero Image Slideshow */}
      <div className="absolute inset-0 grid grid-cols-2 gap-0">
        {/* Left side - Solid background with overlay */}
        <div className="relative bg-gradient-to-br from-primary via-blue-800 to-blue-900">
          <div className="absolute inset-0 bg-gradient-to-r from-transparent to-primary/50"></div>
        ...
        <div className="relative overflow-hidden">
          {heroImages.map((image, index) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-l from-transparent via-blue-900/20 to-blue-900/80"></div>
            </motion.div>
          ))}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-20">
        <div className="max-w-2xl">
          ...
          >
            ...
            >
              A School for <span className="text-accent">Healthcare Professionals</span>
            </motion.h1>
            ...
            >
              Transforming qualified healthcare professionals into competent, job-ready experts through structured training and global career pathways.
            </motion.p>
            ...
            >
              <Link to="/programs">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-accent text-primary px-8 py-4 rounded-full hover:bg-accent/90 transition-all font-semibold flex items-center gap-2 shadow-2xl"
                >
                  Explore Programs
                  <ArrowRight size={20} />
                </motion.button>
              ...
              <Link to="/about">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white px-8 py-4 rounded-full hover:bg-white/20 transition-all font-semibold"
                >
                  Learn More
                </motion.button>
              </Link>
